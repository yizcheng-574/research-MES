...
w = 2;
yyaxis left;
H3 = stairs(t_1, appendStairArray(P_renewable) / 1000, 'LineWidth', w);
H4 = stairs(t_1, appendStairArray(P_wind) / 1000, 'LineWidth', w);
set(H3, 'Color', gold, 'LineWidth', 3);
set(H4(1), 'Color', gray, 'LineStyle','--', 'Marker', '.', 'MarkerSize', 13);
set(H4(2), 'Color', brown, 'LineStyle','--', 'Marker', '.', 'MarkerSize', 13);
set(H4(3), 'Color', maroon, 'LineStyle','--','Marker', 'd', 'MarkerSize', 13);
