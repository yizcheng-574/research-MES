        ...
        Le_max = [2 , 2.5 , 1.5] * 1000; % 基荷
        Le_dr_rate = [0.1, 0.2, 0.4];% 最大可平移负荷功率占基荷的比值
        Lh_max = [1 , 1 , 2] * 1000;
        Lh_dr_rate = [0.1, 0.3, 0.3];% 最大可平移负荷功率占基荷的比值
...
%         EH2_windP = windValue(:,1);
        ...
        ES1_para = [500, 0.8, 0.2, 0.4, 0.4, 6, 0.9];
        ES2_para = [500, 0.85, 0.15, 0.4, 0.4, 6, 0.9];
        ES3_para = [500, 0.85, 0.15, 0.4, 0.4, 6, 0.9];
